...
h7 python3 SubscriberAppln.py -d "10.0.0.1:5556" -T 4 -n sub1 -i 50 > sub1.out 2>&1 &
h8 python3 SubscriberAppln.py -d "10.0.0.1:5556" -T 5 -n sub2 -i 50 > sub2.out 2>&1 &
h9 python3 SubscriberAppln.py -d "10.0.0.1:5556" -T 4 -n sub3 -i 50 > sub3.out 2>&1 &
h10 python3 SubscriberAppln.py -d "10.0.0.1:5556" -T 5 -n sub4 -i 50 > sub4.out 2>&1 &
