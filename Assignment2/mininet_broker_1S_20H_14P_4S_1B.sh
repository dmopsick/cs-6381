h1 python3 DiscoveryAppln.py -P 14 -S 4 > discovery.out 2>&1 &
...
h12 python3 PublisherAppln.py -d "10.0.0.1:5556" -a "10.0.0.12" -T 5 -n pub11 > pub11.out 2>&1 &
h13 python3 PublisherAppln.py -d "10.0.0.1:5556" -a "10.0.0.13" -T 5 -n pub12 > pub12.out 2>&1 &
h14 python3 PublisherAppln.py -d "10.0.0.1:5556" -a "10.0.0.14" -T 5 -n pub13 > pub13.out 2>&1 &
h15 python3 PublisherAppln.py -d "10.0.0.1:5556" -a "10.0.0.15" -T 5 -n pub14 > pub14.out 2>&1 &
h16 python3 SubscriberAppln.py -d "10.0.0.1:5556" -T 4 -n sub1 -i 60 > sub1.out 2>&1 &
h17 python3 SubscriberAppln.py -d "10.0.0.1:5556" -T 5 -n sub2 -i 60 > sub2.out 2>&1 &
h18 python3 SubscriberAppln.py -d "10.0.0.1:5556" -T 4 -n sub3 -i 60 > sub3.out 2>&1 &
h19 python3 SubscriberAppln.py -d "10.0.0.1:5556" -T 5 -n sub4 -i 60 > sub4.out 2>&1 &
h20 python3 BrokerAppln.py -d "10.0.0.1:5556"  -a "10.0.0.20" -n broker1 > broker1.out 2>&1 &